...
export default function ClassesPage() {
  ...
  function openEdit(cls: Class) {
    setEditing(cls);
    setForm({ nom: cls.nom, niveau: cls.niveau, annee: cls.annee });
    setShowForm(true);
  }
      ...
      {showForm && (
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 mb-6">
          ...
          <div className="flex gap-3">
            <button
              onClick={submit}
              disabled={!form.nom || !form.niveau || !form.annee || isPending}
            ...
            <div key={cls.id} className="bg-white rounded-xl border border-gray-200 shadow-sm p-5 hover:shadow-md transition-shadow">
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="flex gap-1">
                  ...
                  <button
                    onClick={() => { if (window.confirm(`Supprimer "${cls.nom}" ?`)) remove.mutate(cls.id); }}
              ...
              <p className="text-sm text-gray-500">{cls.niveau}</p>
